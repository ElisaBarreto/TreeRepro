...
- 2026-09-25 — R14: prepare:imports writes user-plots.import.csv from PIs_per_plot_filtered.csv (plan 13f).
- 2026-09-26 — R11: a rejected row keeps no character of the e-mail (was first letter and domain).
- 2026-09-26 — R11: a failed `user_plots` batch's `error` drops the quoted row text.
