const PATHS = {
  ...
  user: 'M13 6.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM3.5 17c0-3.2 2.9-5.5 6.5-5.5s6.5 2.3 6.5 5.5',
  ...
  help: 'M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0zM7.75 7.75a2.25 2.25 0 1 1 3.5 1.85c-.9.6-1.25 1.05-1.25 2.15M10 14v.5',
  pulse: 'M2.5 10.5h3.5l2-5.5 3.5 11 2-8.5 1.5 3h3',
  thumbsUp:
    'M6.5 9v7.5h-3V9zM6.5 9l3-5.5c1.2 0 2 .9 1.8 2.1L10.8 8h4.4a1.5 1.5 0 0 1 1.5 1.8l-1.2 5.5a1.5 1.5 0 0 1-1.5 1.2H6.5',
  thumbsDown:
    'M6.5 11V3.5h-3V11zM6.5 11l3 5.5c1.2 0 2-.9 1.8-2.1L10.8 12h4.4a1.5 1.5 0 0 0 1.5-1.8l-1.2-5.5a1.5 1.5 0 0 0-1.5-1.2H6.5',
